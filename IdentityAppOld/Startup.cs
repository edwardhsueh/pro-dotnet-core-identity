...
namespace IdentityApp {
    ...
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            // Because the IdentityDbContext class is defined in a different assembly, 
            // I have to tell Entity Framework Core to 
            // -- Create database migrations in the IdentityApp project, like this:            
            ...
            // The reason that ASP.NET Core threw exceptions for requests to restricted URLs in Chapter 3 was that no services had been registered to authentication requests. 
            // The AddDefaultIdentity method sets up those services using sensible default values. 
            // The generic type argument specifies the class Identity will use to represent users. 
            // The default class is IdentityUser, which is included in the Identity package .
